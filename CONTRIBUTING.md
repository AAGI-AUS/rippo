# Contributing to {rippo}

This outlines how to propose a change to {rippo}.
...
help you write a unit test, if needed). See the {tidyverse} guide on
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("AAGI-AUS/rippo", fork = TRUE)`.
...
- We use [air](https://posit-dev.github.io/air/) to format the code
  style. But please don’t restyle code that has nothing to do with your
  PR.
